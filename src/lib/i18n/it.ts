...
export const IT = {
  ...
  "room.leaveLobby": "Liberi il tuo posto al tavolo. Puoi rientrare col link finché la stanza è aperta.",
  "room.leaveGame": "Ti ritiri dalla partita: le tue proprietà tornano alla banca e non si rientra.",
